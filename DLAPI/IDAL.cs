...
namespace DLAPI
{
    public interface IDAL
    {
        ...
        IEnumerable<DO.BusOnTrip> GetBusOnTripBy(Predicate<DO.BusOnTrip> predicate);
        ...
        IEnumerable<DO.Line> GetLine(Predicate<DO.Line> predicate);
        ...
        IEnumerable<DO.LineStation> GetLineStation(Predicate<DO.LineStation> predicate);
        ...
        IEnumerable<DO.LineTrip> GetLineTrip(Predicate<DO.LineTrip> predicate);
        ...
        IEnumerable<DO.Station> GetStation(Predicate<DO.Station> predicate);
        ...
        IEnumerable<DO.Trip> GetTrip(Predicate<DO.Trip> predicate);
        ...
        IEnumerable<DO.User> GetUser(Predicate<DO.User> predicate);
